...
SET
  `value` = json_set(
    ...
    '$.identity.shortName', 'shakdingo',
    '$.identity.latinName', 'shakdingo',
    '$.identity.author', 'shakdingo',
    '$.footer.statement', '© 2026 shakdingo · 在持续学习中构建。',
    '$.hero.eyebrow', 'SHAKDINGO / KNOWLEDGE GARDEN',
    '$.hero.lead', '我是 shakdingo，一名关注软件架构、AI 工作流与 IoT 的开发者。这里保存问题如何被理解、系统如何被构建。',
    '$.hero.nowValue', '持续构建中',
    '$.hero.intro.lines', json('["正在连接知识节点","正在展开个人坐标","欢迎进入 shakdingo 的数字花园"]'),
    '$.about.name', 'shakdingo',
